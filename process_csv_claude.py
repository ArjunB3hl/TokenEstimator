...
def process_csv_files(directory='.', output_column='response', json_filename='claude-data.json'):
    ...
    for csv_file in csv_files:
        try:
            ...
            for idx, row in df.iterrows():
                ...
                response_dict = get_claude_response(prompt)
                ...
                time.sleep(3)  # Delay for 2 seconds to avoid rate limiting
